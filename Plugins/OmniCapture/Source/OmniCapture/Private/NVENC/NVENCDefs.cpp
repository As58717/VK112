...
namespace OmniNVENC
{
    ...
    const FGuid& FNVENCDefs::CodecGuid(ENVENCCodec Codec)
    {
        ...
        case ENVENCCodec::HEVC:
            // NV_ENC_CODEC_HEVC_GUID {0x790CDC88,0x4522,0x4D7B,{0x94,0x25,0xBD,0xA9,0x97,0x5F,0x76,0x03}}
            return GuidFromComponents(0x790CDC88, 0x45224D7B, 0x9425BDA9, 0x975F7603);
        case ENVENCCodec::H264:
        default:
            // NV_ENC_CODEC_H264_GUID {0x6BC82762,0x4E63,0x4CA4,{0xAA,0x85,0x1E,0x50,0xF3,0x21,0xF6,0xBF}}
